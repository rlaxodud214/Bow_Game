...
public class WMG_Axis : WMG_GUI_Functions {
	...
	public autoGrowShrinkType AutoGrowShrinkType { get {return _AutoGrowShrinkType;} 
		set {
	...
	public bool OppositeSideTicks { get {return _OppositeSideTicks;} 
		set {
	...
	#if TMP_PRESENT
	public TMP_FontAsset AxisLabelFont { get {return _AxisLabelFont;} 
		set {
	...
	public bool AxisBoundedLabels { get {return _AxisBoundedLabels;} 
		set {
	...
	public bool OppositeSideLabels { get {return _OppositeSideLabels;} 
		set {
	...
	public void UpdateTitle() {
		if (AxisTitle != null) {
			...
			float tickOffset = 0;
			if (OppositeSideLabels == OppositeSideTicks) { // don't offset label positions based on tick size if ticks drawn on the opposite side of the labels
